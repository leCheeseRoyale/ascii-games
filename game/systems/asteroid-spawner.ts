import { defineSystem, rng } from '@engine'
...
export const asteroidSpawnerSystem = defineSystem({
  ...
  update(engine, dt) {
    ...
    switch (edge) {
      case 0: x = rng(0, w); y = -30; break        // top
      case 1: x = w + 30; y = rng(0, h); break      // right
      case 2: x = rng(0, w); y = h + 30; break      // bottom
      default: x = -30; y = rng(0, h); break         // left
    }
